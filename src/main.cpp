  ...
  void drawSystem()
  {
    ...
    void keyboardFunc( unsigned char key, int x, int y )
    {
        ...
        case 50: //2
            ...
            cout << "Pendulum System selected\n";
            break;
        case 51: //3
            system = new ClothSystem(8,8);
            cout << "Cloth System selected\n";
            break;

        case 101: //e
            timeStepper = new ForwardEuler();
            cout << "Euler selected, god have mercy on your soul\n";
            break;
        case 114: //r
            timeStepper = new RK4();
            cout << "Provided Runge-Kutta solver selected\n";
            break;
        case 107: //k
            timeStepper = new RungeKutta();
            cout << "Self-written Runge-Kutta solver selected\n";
            break;
        case 116: //t
            timeStepper = new Trapzoidal();
            cout << "Trapezoidal solver selected\n";
            break;

        case 115: //s
            system->springsOn = system->springsOn ? false : true;
            cout << "Springs on/off\n";
            break;
        case 112: //p
            system->particlesOn = system->particlesOn ? false : true;
            cout << "Particles on/off\n";
            break;
    ...
    void specialFunc( int key, int x, int y )
    {
        ...
        case 101: //up
            ...
            break;
        case 102: //right
            cout << "Move cloth to the right\n";
            system->shift(1, 0);
            break;
        case 103: //down
            cout << "Move cloth down\n";
            system->shift(0, -1);
            break;
        }
        //glutPostRedisplay();
